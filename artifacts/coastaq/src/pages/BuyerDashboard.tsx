...
const PAYMENT_STATUS_CONFIG: Record<string, { label: string; color: string; Icon: any }> = {
  pending:   { label: "Awaiting Payment",   color: "bg-gray-100 text-gray-600",       Icon: Clock },
  escrowed:  { label: "Protected by Escrow", color: "bg-blue-100 text-blue-700",     Icon: Shield },
  released:  { label: "Funds Released",      color: "bg-green-100 text-green-700",   Icon: CheckCircle2 },
  refunded:  { label: "Refunded",            color: "bg-orange-100 text-orange-700", Icon: XCircle },
  disputed:  { label: "Dispute Open",        color: "bg-red-100 text-red-700",       Icon: Flag },
};
...
export default function BuyerDashboard() {
  ...
  const { data: ordersData, isLoading: ordersLoading, refetch: refetchOrders } = useListOrders({
  ...
  const submitDispute = useCallback(async () => {
    ...
    setEscrowLoadingId(null);
  }, [disputeOrderId, disputeReason, refetchOrders, toast]);
