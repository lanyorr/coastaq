...
async function seed() {
  console.log("🌱 Seeding Coastaq with Jiji.ng categories...");
  ...
  // ══════════════════════════════════════════════════════════════
  //  CATEGORIES  (Jiji.ng structure — 2 levels: parent > child)
  // ══════════════════════════════════════════════════════════════
  ...
  console.log(`✅ ${allCats.length} categories created (13 parent + subcategories)`);
  ...
  await db.insert(productsTable).values([
    ...
    },
    {
      ...
      description: "100% copper winding, electric start, dual fuel, runs 8 hours on full tank. Whisper-quiet operation.",
      price: "195.00",
      stock: 20,
      condition: "NEW",
    ...
    },
    {
      ...
      description: "Premium fabric upholstery, solid hardwood frame. Seats 5 comfortably. Fast delivery.",
      price: "450.00",
      stock: 4,
      condition: "NEW",
    ...
    },
    {
      ...
      description: "Lightweight mesh upper, Max Air unit in heel. Available in sizes 40-46. Original Nike.",
      price: "89.00",
      stock: 30,
      condition: "NEW",
